...
VALUES (11894307208, 'CLIENTE PROPOSTA DDB <= SYSDATE - 180, DAC <= SYSDATE - 90', 0.2, 12345678, '2019-12-02', '1952-09-01', '2019-09-01');
...
INSERT
  INTO beneficiarios_INSS 
VALUES (62659343179, 'CLIENTE DDB > SYSDATE - 180', 0.15, 32165498, '2019-03-01', '1951-10-11', '2019-12-01');